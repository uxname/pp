...
- [ ] Сделать чтобы промпты хранились в файлах в папке ./koda/prompts, а в конфиге были только пути к этим файлам. В том числе и промпт, который добавляется при вызове команды pack.
